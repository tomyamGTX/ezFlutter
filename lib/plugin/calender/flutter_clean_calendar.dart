...
import 'package:ez_flutter/plugin/calender/simple_gesture_detector.dart';
...
// Export NeatCleanCalendarEvent for using it in the applicat'../../ez_flutter/lib/plugin/calender/clean_calendar_event.dart'_event.dart';
        ...
        dayWidgets.add(
          CalendarTile(
            ...
            isSelected: widget.isHijri
                ? Utils.isSameDayHijri(selectedDate, day)
