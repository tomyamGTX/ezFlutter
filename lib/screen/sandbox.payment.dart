...
class SandBoxPayment extends StatefulWidget {
  ...
  @override
  State<SandBoxPayment> createState() => _SandBoxPaymentState();
}

class _SandBoxPaymentState extends State<SandBoxPayment> {
  var index = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: Consumer<SandBoxPaymentProvider>(
                                  ...
                                  child: ListTile(
                                      ...
                                      trailing: TextButton(
                                        onPressed: () async {
                                          ...
                                          Provider.of<SandBoxPaymentProvider>(
                                                  context,
                                                  listen: false)
